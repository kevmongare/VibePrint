          ...
          <div className="flex justify-between h-14">
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                <Link to={'/'}>
                  <img 
                    src={isScrolled ? LogoLight : LogoLight}
                    alt="Logo" 
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-2 border rounded-md leading-5 focus:outline-none focus:ring-1 sm:text-sm ${
                      isScrolled 
                        ...
                        : 'border-gray-300 bg-white placeholder-gray-500 focus:ring-[#007BFF] focus:border-[#007BFF] text-gray-800'
                    }`}
            ...
            <div className="flex items-center">
              <div className="hidden md:flex items-center space-x-4">
                {actionButtons.map((button) => (
                  <button 
                    key={button.id}
                    className={`relative p-1 ${isScrolled ? `text-gray-500 hover:text-[${button.hoverColor}]` : 'text-gray-500 hover:text-[${button.hoverColor}]'}`}
                    title={button.title}
                  >
                    {button.icon}
                  </button>
                ...
                <button 
                  className={`relative p-1 ${isScrolled ? 'text-gray-500 hover:text-[#007BFF]' : 'text-gray-500 hover:text-[#007BFF]'}`}
                  onClick={onCartClick}
